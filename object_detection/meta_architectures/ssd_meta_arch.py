...
General tensorflowFolder implementation of convolutional Multibox/SSD detection
models.
"""
...
class SSDMetaArch(model.DetectionModel):
  ...
  def __init__(self,
    ...
    Args:
      ...
      add_summaries: boolean (default: True) controlling whether summary ops
        should be added to tensorflowFolder graph.
  ...
  def _summarize_target_assignment(self, groundtruth_boxes_list, match_list):
    """Creates tensorflowFolder summaries for the input boxes and anchors.
