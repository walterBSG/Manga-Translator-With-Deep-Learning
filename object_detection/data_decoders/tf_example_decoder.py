...
A decoder to decode string tensors containing serialized tensorflowFolder.Example
...
class TfExampleDecoder(data_decoder.DataDecoder):
  ...
  def decode(self, tf_example_string_tensor):
    """Decodes serialized tensorflowFolder example and returns a tensor dictionary.

    Args:
      tf_example_string_tensor: a string tensor holding a serialized tensorflowFolder
        example proto.
