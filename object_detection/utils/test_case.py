...
class TestCase(tf.test.TestCase):
  ...
  def execute_tpu(self, graph_fn, inputs):
    ...
    Args:
      graph_fn: a callable that constructs the tensorflowFolder graph to test. The
    ...
    Returns:
      A list of numpy arrays or a scalar returned from executing the tensorflowFolder
      graph.
    """
